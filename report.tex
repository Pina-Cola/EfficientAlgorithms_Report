...
13 & n $\cdot$ $k$ & Loop \\
14 & $2^n$ $\cdot$ $n$ $\cdot$ $k$ & Recusrsive call \\
...
\begin{align*}
& 1 + 1+ k + k +k + k + k + k + k \\
& + n \cdot k + 2^n \cdot n \cdot k + n \cdot k \\
& =  2 + 7k + 2(n \cdot k) + 2^n \cdot n \cdot k \\
& = 2 + 7k + 2n \cdot 2k + 2^n \cdot n \cdot k \\
& \in O(2^n)
\end{align*}
The runtime of the naive method is in $O(2^n)$.
\end{minipage}
