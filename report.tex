...
The recursive calls are made on substrings that are one symbol shorter than the original substring. Therefore, the maximum number of recursive calls is proportional to the square of the length of the input string, which is $O(n^2)$.
