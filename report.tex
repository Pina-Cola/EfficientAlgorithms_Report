...
Formal languages and grammars can be used in different fields, for example for AI learning methods \cite{rosenschein1985formal}. The CYK-algorithm is a method to examine if an input word is part of a formal language. 
