...
The recursive call is made twice in each iteration in the innermost loop. Therefore, the number of recursive calls made by the function is proportional to the number of iterations of the innermost loop, which is $n^3$.
