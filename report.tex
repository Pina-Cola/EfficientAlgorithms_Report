...
The recursive call is made twice in each iteration in the innermost loop (line 18). Therefore, the number of recursive calls made by the function is proportional to the number of iterations of the innermost loop, which is $n^3$.
...
The parser iterates over all elements of the table and for each entry, it makes a recursive call. The overall time complexity of the function is $O(n^3)$.
